...
setup(
    ...
    data_files=[
        ...
        (join(share_directory, 'robots/ads-dv'), glob('robots/ads-dv/*.yaml') + glob('robots/ads-dv/*.urdf.xacro')),
        (join(share_directory, 'robots/ads-dv-2021'),
         glob('robots/ads-dv-2021/*.yaml') + glob('robots/ads-dv-2021/*.urdf.xacro')),
        (join(share_directory, 'robots/eufs'), glob('robots/eufs/*.yaml') + glob('robots/eufs/*.urdf.xacro')),
        (join(share_directory, 'robots/wheelchair-21'),
         glob('robots/wheelchair-21/*.yaml') + glob('robots/wheelchair-21/*.urdf.xacro')),
    ],
