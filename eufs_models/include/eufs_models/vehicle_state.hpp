...
struct State {
    ...
    inline std::string getString() const {
        std::string str = "x:" + std::to_string(x) + "| y:" + std::to_string(y) + "| z:" + std::to_string(z) +
                          "| yaw:" + std::to_string(yaw) + "| v_x:" + std::to_string(v_x) +
                          "| v_y:" + std::to_string(v_y) + "| v_z:" + std::to_string(v_z) +
                          "| r_x:" + std::to_string(r_x) + "| r_y:" + std::to_string(r_y) +
                          "| r_z:" + std::to_string(r_z) + "| a_x:" + std::to_string(a_x) +
                          "| a_y:" + std::to_string(a_y) + "| a_z:" + std::to_string(a_z);
        return str;
    }
