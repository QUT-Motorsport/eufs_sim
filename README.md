...
1. New gui launcher for quality of life
2. Option to have torque-controlled car
3. Optionally noisy environments (only with random and from-image tracks)
4. Random track generation [Experimental]
     
     4.1. Functional random image generation [Implemented]
    
     4.2. Distinguish between yellow and blue cones [Unimplemented]
     
     4.3. Have better spacing on cones [Mostly Implemented]
     
     4.4. Actually good random image generation [Not Implemented] :P
5. Track-From-Image
