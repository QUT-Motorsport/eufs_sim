...
# Note: Due to some python launch file subtlety, the launch_setup function must be kept seperate from
# generate_launch_description, otherwise it is not possible to access the parameters that are passed into the simulation
