...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument(name="config",
                              ...
                              description="Relative path to config file (within package supplied by config_loc)"),

        DeclareLaunchArgument(name="config_loc",
                              default_value="eufs_launcher",
                              description="Decides which package to load config file from"),

        DeclareLaunchArgument(name="gui",
                              default_value="true",
                              description="Condition for GUI launch, if false, GUI auto-launches according to "
